  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-8 gap-6">
      <div className="text-center">
        <h1 className="text-3xl font-semibold tracking-tight mb-2">Singularity</h1>
...
function PermissionsSlide({ onNext }: { onNext: () => void }) {
  ...
  return (
    <OnboardingShell
      title="Permissions"
      description="Singularity needs these permissions to capture your screen and audio."
      footer={
        restartRequired ? (
          <div className="mt-auto flex flex-col gap-2">
            <p className="text-xs text-muted-foreground text-center">
              After enabling the permission in System Settings, restart Singularity
