...
interface ChatState {
  ...
  isStreaming: boolean;
  /** Microphone is open and a dictation clip is being recorded. */
  isDictating: boolean;
  /** A finished clip is being transcribed. */
  ...
  persist(
    (set) => ({
      ...
      actions: {
        ...
        setDictating: (active) => set({ isDictating: active }),
